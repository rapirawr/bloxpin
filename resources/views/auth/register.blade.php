<x-auth-layout>
    <div>
        <h1 class="text-3xl font-display font-black tracking-tight text-dark dark:text-white">Buat Akun Baru</h1>
        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
            Sudah punya akun? 
            <a href="{{ route('login') }}" class="font-bold text-dark dark:text-white hover:underline decoration-2 underline-offset-4">Masuk ke akun Anda</a>
        </p>
    </div>
    ...
    <div class="mt-8">
        ...
        <p class="mt-8 text-center text-xs text-gray-500 dark:text-gray-400">
            ...
            <a href="#" class="font-bold text-dark dark:text-white hover:underline">Ketentuan Layanan</a> 
            dan 
            <a href="#" class="font-bold text-dark dark:text-white hover:underline">Kebijakan Privasi</a> kami.
        </p>
    </div>
</x-auth-layout>
