...
<div class="flex-shrink-0 relative {{ $size }}" title="Akun Terverifikasi">
    <!-- Rotating Background -->
    <div class="absolute inset-0 text-white/80 animate-[spin_10s_linear_infinite]">
    ...
    <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
        <svg viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="{{ $checkSize }} drop-shadow-sm">
