...
>
    ...
    >
        <div class="absolute inset-0 bg-dark/60 dark:bg-dark/80 backdrop-blur-sm"></div>
    </div>

    <div
        x-show="show"
        class="mb-6 bg-white dark:bg-card rounded-2xl overflow-hidden shadow-xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto border border-borderlight dark:border-borderdark"
        x-transition:enter="ease-out duration-300"
