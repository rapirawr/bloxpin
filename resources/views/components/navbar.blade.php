<nav class="fixed top-0 left-0 w-full h-[80px] glass-nav z-50 flex items-center px-6 md:px-12 justify-between gap-8 transition-all duration-500">
    ...
    <div class="flex items-center gap-4 shrink-0">
        @auth
            ...
            <!-- Notifications -->
            <a href="{{ route('notifications.index') }}" class="relative w-10 h-10 hidden md:flex items-center justify-center rounded-full hover:bg-gray-100 dark:hover:bg-white/5 transition-all duration-300 text-gray-500 group">
