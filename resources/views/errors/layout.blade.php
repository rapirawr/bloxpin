...
<body class="min-h-screen flex items-center justify-center p-6 overflow-hidden">
    ...
    <div class="max-w-md w-full text-center relative">
        ...
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[15rem] md:text-[20rem] font-black text-white/[0.03] select-none z-0 animate-glow">
            @yield('code')
        </div>
        ...
        <div class="relative z-10 animate-slide-up">
            ...
            <div class="w-20 h-20 bg-white text-black rounded-3xl flex items-center justify-center mx-auto mb-10 shadow-2xl animate-float">
            ...
            <a href="/" class="inline-block bg-white text-black font-black text-xs uppercase tracking-[0.2em] px-10 py-5 rounded-2xl hover:scale-110 hover:shadow-white/20 transition-all active:scale-95 shadow-xl">
                Back to Home
            </a>
        </div>
    </div>
